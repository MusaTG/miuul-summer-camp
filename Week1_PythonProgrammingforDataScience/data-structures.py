...
# Not: Liste, tuple, set ve dictionary veri yapıları aynı zamamda Python Collections (Arrays) olarak geçmektedir.
...
###############################
# String İçerisinde Karakter Sargulamak
###############################
