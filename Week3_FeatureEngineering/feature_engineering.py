...
def load_application_train():
    data = pd.read_csv("Week3_FeatureEngineering/datasets/application_train.csv")
    return data
...
def load():
    data = pd.read_csv("Week3_FeatureEngineering/datasets/titanic.csv")
    return data
...
dff = pd.read_csv("Week3_FeatureEngineering/datasets/course_reviews.csv")
dff.head()
dff.info()
